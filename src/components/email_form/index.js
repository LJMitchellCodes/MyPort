...
class Email_Form extends React.Component {
  ...
  handleSubmit(e) {
    ...
    let templateParams = {
      from_name: email,
      to_name: 'lonniejmitchell@gmail.com',
      subject: subject,
  ...
  render() {
    return (
          ...
          <Form onSubmit={this.handleSubmit.bind(this)} className="Contact-form">
            <p className="contact-form-header"  data-aos='zoom-in' data-aos-duration='3000'>Contact Form</p>
           ...
           <Button className="contact-email-text-btn" variant="outline-light" size="lg" type="submit"  data-aos='zoom-in' data-aos-duration='3000'>
              Submit
              <ClipLoader
                size={5} // or 150px
                color={"#ffffff"}
